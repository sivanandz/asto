...
class SettingsScreen extends StatelessWidget {
  ...
  Widget _buildChartStyleSelector(BuildContext context) {
    return Consumer<AppProvider>(
      builder: (context, provider, child) {
        final currentStyle = provider.preferredVedicStyle;
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () => provider.updateVedicChartStyle(VedicChartStyle.northIndian),
              ),
              ListTile(
                ...
                onTap: () => provider.updateVedicChartStyle(VedicChartStyle.southIndian),
              ),
            ],
          ),
        );
