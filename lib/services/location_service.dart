...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      throw Exception('Location search failed. Please check your connection and try again.');
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('Reverse geocoding failed. Please check your connection and try again.');
    }
  }
