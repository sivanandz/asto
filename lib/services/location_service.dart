  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Secure error handling: log actual error internally, throw generic exception
        debugPrint('Failed to search locations: HTTP ${response.statusCode}');
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('Reverse geocoding failed: HTTP ${response.statusCode}');
      }
      return null;
    } catch (e) {
