...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to retrieve location data. Please try again later.');
      }
    } catch (e) {
      debugPrint('Location search error: $e');
      throw Exception('An error occurred while searching for locations.');
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('An error occurred while getting location from coordinates.');
    }
  }
