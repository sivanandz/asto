...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to search locations. Please try again later.'); // Sanitize error message
      }
    } catch (e) {
      throw Exception('Location search failed.'); // Sanitize error message
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('Reverse geocoding failed.'); // Sanitize error message
    }
  }
