...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      throw Exception('Location search error. Please check your connection and try again.');
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('Reverse geocoding error. Please check your connection and try again.');
    }
  }
