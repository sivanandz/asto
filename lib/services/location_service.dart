...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Location search is currently unavailable. Please try again.');
      }
    } catch (e) {
      throw Exception('Location search error. Please try again.');
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('Location lookup is currently unavailable. Please try again.');
    }
  }
