...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      throw Exception('An error occurred during location search. Please check your connection and try again.');
    }
  }
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      throw Exception('An error occurred while fetching location details. Please try again later.');
    }
  }
