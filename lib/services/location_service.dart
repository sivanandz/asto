  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Sentinel: Prevent leaking HTTP status codes
        throw Exception('Location search failed. Please try again.');
      }
    } catch (e) {
      // Sentinel: Prevent leaking raw exception details
      throw Exception('Location search error occurred. Please try again.');
    }
  }
