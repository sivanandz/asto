...
class LocationService {
  ...
  static Future<List<LocationModel>> searchLocations(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('HTTP error in searchLocations: ${response.statusCode}');
        throw Exception('Failed to search locations.');
      }
    } catch (e) {
      debugPrint('Exception in searchLocations: $e');
  ...
  static Future<LocationModel?> getLocationFromCoordinates(
    ...
    try {
      ...
      debugPrint('Exception in getLocationFromCoordinates: $e');
